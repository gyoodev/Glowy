...
export const bulgarianCitiesWithNeighborhoods: Record<string, string[]> = {
  "София": ["Абдовица", "Американски колеж", "Банишора", "Бели брези", "Бенковски", "Бизнес парк София", "Бокар", "Борово", "Ботунец", "Бояна", "Бункера", "Бъкстон", "Васил Левски", "Витоша", "Враждебна", "Връбница 1", "Връбница 2", "Гевгелийски", "Гео Милев", "Горна баня", "Горубляне", "Гоце Делчев", "Дианабад", "Димитър Миленков", "Драгалевци", "Дружба 1", "Дружба 2", "Дървеница", "Западен парк", "Захарна фабрика", "Зона Б-18", "Зона Б-19", "Зона Б-5", "Иван Вазов", "Изгрев", "Изток", "Илинден", "Илиянци", "Карпузица", "Киноцентър", "Княжево", "Красна поляна 1", "Красна поляна 2", "Красна поляна 3", "Красно село", "Кремиковци", "Крива река", "Кръстова вада", "Лагера", "Левски В", "Левски Г", "Летище София", "Лозенец", "Люлин 1", "Люлин 10", "Люлин 2", "Люлин 3", "Люлин 4", "Люлин 5", "Люлин 6", "Люлин 7", "Люлин 8", "Люлин 9", "Малинова долина", "Манастирски ливади", "Медицинска академия", "Младост 1", "Младост 1А", "Младост 2", "Младост 3", "Младост 4", "Модерно предградие", "Мотописта", "Мусагеница", "Надежда 1", "Надежда 2", "Надежда 3", "Надежда 4", "Обеля", "Обеля 1", "Обеля 2", "Оборище", "Овча купел", "Овча купел 1", "Овча купел 2", "Орландовци", "Павлово", "Подуяне", "Полигона", "Разсадника", "Редута", "Република", "Света Троица", "Свобода", "Сердика", "Седемнадесети километър", "Симеоново", "Слатина", "Стефан Караджа", "Стрелбище", "Студентски град", "Сухата река", "Толстой", "Триъгълника", "Факултета", "Фондови жилища", "Хаджи Димитър", "Хиподрума", "Христо Ботев", "Център", "Яворов"].sort(),
  "Пловдив": ["Беломорски", "Гагарин", "Гладно поле", "Западен", "Изгрев", "Индустриална зона - Изток", "Индустриална зона - Север", "Индустриална зона - Юг", "Каменица 1", "Каменица 2", "Капана", "Коматево", "Кършияка", "Кючук Париж", "Мараша", "Младежки хълм", "Остромила", "Прослав", "Северен", "Смирненски", "Старият град", "Съдийски", "Тракия", "Център", "Южен"].sort(),
  "Варна": ["Акациите", "Аспарухово", "Бриз", "Виница", "Владислав Варненчик", "Галата", "Гръцка махала", "ЖП Гара", "Западна промишлена зона", "Изгрев", "Колхозен пазар", "Левски", "Максуда", "Младост 1", "Младост 2", "Морска градина", "Победа", "Погреби", "Промишлена зона - Запад", "Свети Иван Рилски", "Свети Никола", "Траката", "Трошево", "Христо Ботев", "Център", "Чайка"].sort(),
  "Бургас": ["Акациите", "Банево", "Братя Миладинови", "Ветрен", "Възраждане", "Горно Езерово", "Долно Езерово", "Зорница", "Изгрев", "Крайморие", "Лазур", "Лозово", "Меден рудник", "Победа", "Сарафово", "Славейков", "Център", "Черно море"].sort(),
  "Русе": ["Възраждане", "Долапите", "ДЗС", "Дружба 1", "Дружба 2", "Дружба 3", "Здравец", "Източна промишлена зона", "Образцов чифлик", "Родина 1", "Родина 2", "Родина 3", "Родина 4", "Средна кула", "Тракция", "Център", "Чародейка", "Ялта"].sort(),
  "Стара Загора": ["Аязмото", "Бедечка", "Голеш", "Дъбрава", "Железник", "Зора", "Индустриална зона", "Казански", "Кольо Ганчев", "Лозенец", "Македонски", "Самара 1", "Самара 2", "Самара 3", "Три чучура", "Център"].sort(),
  "Плевен": ["9-ти квартал", "Воден", "Дружба 1", "Дружба 2", "Дружба 3", "Дружба 4", "Идеален център", "Кайлъка", "Мара Денчева", "Момин геран", "Сторгозия", "Център"].sort(),
  "Велико Търново": ["Акация", "Асенов", "Бузлуджа", "Варуша", "Зона А", "Зона Б", "Картала", "Колю Фичето", "Света гора", "Свети четиридесет мъченици", "Славянски", "Старият град", "Триъгълника", "Чолаковци", "Широк център"].sort(),
  "Благоевград": ["Грамада", "Еленово", "Запад", "Орлова чука", "Освобождение", "Ридо", "Струмско", "Център"].sort(),
  "Хасково": ["Бадема", "Болярово", "Дружба 1", "Дружба 2", "Куба", "Орфей", "Овчарски", "Република", "Тракийски", "Училищни", "Хисаря", "Център"].sort(),
  "Перник": ["Бела вода", "Изток", "Калкас", "Мошино", "Проучване", "Ралица", "Тева", "Твърди ливади", "Център", "Църква"].sort(),
  "Шумен": ["Боян Българанов", "Гривица", "Дивдядово", "Добруджански", "Еверест", "Индустриална зона", "Макак", "Мътница", "Тракия", "Център", "Херсон"].sort(),
  "Ямбол": ["Аврен", "Бенковски", "Възраждане", "Златен рог", "Изток", "Каргон", "Райна Княгиня", "Хале", "Център"].sort(),
  "Сливен": ["Българка", "Даме Груев", "Дружба", "Звездите", "Индустриална зона", "Клуцохор", "Комлука", "Надежда", "Ново село", "Република", "Сини камъни", "Строител", "Център"].sort(),
  "Добрич": ["Балик", "Добротица", "Дружба 1", "Дружба 2", "Дружба 3", "Дружба 4", "Изгрев", "Рилци", "Строител", "Христо Ботев", "Център"].sort(),
  "Пазарджик": ["Запад", "Ивайло", "Младост", "Ставропол", "Супер център", "Устрем", "Център"].sort(),
  "Враца": ["Бистрец", "Дъбника", "Кулата", "Медковец", "Серов", "Център", "Химко"].sort(),
  "Кюстендил": ["Герена", "Запад", "Изток", "Колуша", "Могилата", "Осогово", "Център"].sort(),
  "Габрово": ["Беленци", "Борово", "Войново", "Гачевци", "Инструмент", "Йовковци", "Лъката", "Младост", "Недевци", "Радецки", "Русевци", "Трендафил", "Център", "Шенини"].sort(),
  "Видин": ["Акация", "Бонония", "Заводска", "Калето", "Крум Бъчваров", "Нов път", "Панония", "Петко Каравелов", "Строител", "Христо Ботев", "Център"].sort(),
  "Монтана": ["Изгрев", "Идеалният център", "Кошарник", "Младост 1", "Младост 2", "Огоста", "Плиска", "Пъстрина", "Център"].sort(),
  "Търговище": ["Въбел", "Запад 1", "Запад 2", "Запад 3", "Изток", "Център"].sort(),
  "Ловеч": ["Вароша", "Дикисана", "Здравец", "Младост", "Промишлена зона", "Червен бряг", "Център"].sort(),
  "Кърджали": ["Байкал", "Боровец", "Веселчане", "Възрожденци", "Гледка", "Прилепци", "Резбарци", "Студен кладенец", "Център"].sort(),
  "Разград": ["Васил Левски", "Водна централа", "Орел", "Оборище", "Перистър", "Център"].sort(),
  "Смолян": ["Горно Райково", "Долно Райково", "Каптажа", "Нов център", "Петровица", "Стар център", "Устово"].sort(),
  "Силистра": ["Деленки", "Изток", "Промишлена зона", "Център"].sort(),
};
